export default function Lab1() {
    ...
    render the gaps.
            ...
            <div id="wd-lists">
                ...
                My favorite recipe - Bacon Egg and Cheese:
                <ol id="wd-your-favorite-recipe">
                    <li>Cook bacon on pan</li>
                    <li>Put bagel in toaster</li>
                    <li>Flip bacon</li>
                    <li>Take bacon out</li>
                    <li>Crack then cook eggs</li>
                    <li>Put cheese on eggs</li>
                    <li>Put everything on the bagel</li>
                    <li>Time to eat!</li>
                </ol>
